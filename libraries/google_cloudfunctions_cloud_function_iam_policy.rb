...
# A provider to manage Cloud Functions IAM Policy resources.
class CloudFunctionIamPolicy < GcpResourceBase
  name 'google_cloudfunctions_cloud_function_iam_policy'
  desc 'CloudFunction Iam Policy'
  ...
  def to_s
    "CloudFunction IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/locations/{{location}}/functions/{{name}}:getIamPolicy'
  end
end
