...
class DiskTypeIamPolicy < GcpResourceBase
  name 'google_compute_disk_type_iam_policy'
  desc 'DiskType Iam Policy'
  ...
  def to_s
    "DiskType IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/zones/{{zone}}/diskTypes/{{name}}/getIamPolicy'
  end
end
