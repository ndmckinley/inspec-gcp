...
class BackendServiceIamPolicy < GcpResourceBase
  name 'google_compute_backend_service_iam_policy'
  desc 'BackendService Iam Policy'
  ...
  def to_s
    "BackendService IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/backendServices/{{name}}/getIamPolicy'
  end
end
