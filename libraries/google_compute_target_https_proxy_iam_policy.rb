...
class TargetHttpsProxyIamPolicy < GcpResourceBase
  name 'google_compute_target_https_proxy_iam_policy'
  desc 'TargetHttpsProxy Iam Policy'
  ...
  def to_s
    "TargetHttpsProxy IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/targetHttpsProxies/{{name}}/getIamPolicy'
  end
end
