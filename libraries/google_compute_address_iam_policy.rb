...
class AddressIamPolicy < GcpResourceBase
  name 'google_compute_address_iam_policy'
  desc 'Address Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/addresses/{{name}}/getIamPolicy'
  end
end
