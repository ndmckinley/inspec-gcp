...
class RegionDiskTypeIamPolicy < GcpResourceBase
  name 'google_compute_region_disk_type_iam_policy'
  desc 'RegionDiskType Iam Policy'
  ...
  def to_s
    "RegionDiskType IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/diskTypes/{{name}}/getIamPolicy'
  end
end
