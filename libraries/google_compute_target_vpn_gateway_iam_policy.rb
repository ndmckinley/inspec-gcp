...
class TargetVpnGatewayIamPolicy < GcpResourceBase
  name 'google_compute_target_vpn_gateway_iam_policy'
  desc 'TargetVpnGateway Iam Policy'
  ...
  def to_s
    "TargetVpnGateway IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/targetVpnGateways/{{name}}/getIamPolicy'
  end
end
