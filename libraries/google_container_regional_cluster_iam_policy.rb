...
class RegionalClusterIamPolicy < GcpResourceBase
  name 'google_container_regional_cluster_iam_policy'
  desc 'RegionalCluster Iam Policy'
  ...
  def to_s
    "RegionalCluster IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/locations/{{location}}/clusters/{{name}}/getIamPolicy'
  end
end
