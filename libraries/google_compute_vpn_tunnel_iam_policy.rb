...
class VpnTunnelIamPolicy < GcpResourceBase
  name 'google_compute_vpn_tunnel_iam_policy'
  desc 'VpnTunnel Iam Policy'
  ...
  def to_s
    "VpnTunnel IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/vpnTunnels/{{name}}/getIamPolicy'
  end
end
