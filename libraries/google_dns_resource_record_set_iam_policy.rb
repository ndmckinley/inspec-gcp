...
# A provider to manage Cloud DNS IAM Policy resources.
class ResourceRecordSetIamPolicy < GcpResourceBase
  name 'google_dns_resource_record_set_iam_policy'
  desc 'ResourceRecordSet Iam Policy'
  ...
  def to_s
    "ResourceRecordSet IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/managedZones/{{managed_zone}}/rrsets?name={{name}}&type={{type}}/getIamPolicy'
  end
end
