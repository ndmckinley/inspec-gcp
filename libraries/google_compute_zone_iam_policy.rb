...
class ZoneIamPolicy < GcpResourceBase
  name 'google_compute_zone_iam_policy'
  desc 'Zone Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/zones/{{name}}/getIamPolicy'
  end
end
