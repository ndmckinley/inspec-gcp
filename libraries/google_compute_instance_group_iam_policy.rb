...
class InstanceGroupIamPolicy < GcpResourceBase
  name 'google_compute_instance_group_iam_policy'
  desc 'InstanceGroup Iam Policy'
  ...
  def to_s
    "InstanceGroup IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/zones/{{zone}}/instanceGroups/{{name}}/getIamPolicy'
  end
end
