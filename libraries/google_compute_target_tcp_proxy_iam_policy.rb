...
class TargetTcpProxyIamPolicy < GcpResourceBase
  name 'google_compute_target_tcp_proxy_iam_policy'
  desc 'TargetTcpProxy Iam Policy'
  ...
  def to_s
    "TargetTcpProxy IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/targetTcpProxies/{{name}}/getIamPolicy'
  end
end
