...
class RouteIamPolicy < GcpResourceBase
  name 'google_compute_route_iam_policy'
  desc 'Route Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/global/routes/{{name}}/getIamPolicy'
  end
end
