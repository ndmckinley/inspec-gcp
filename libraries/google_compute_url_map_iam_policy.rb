...
class UrlMapIamPolicy < GcpResourceBase
  name 'google_compute_url_map_iam_policy'
  desc 'UrlMap Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/global/urlMaps/{{name}}/getIamPolicy'
  end
end
