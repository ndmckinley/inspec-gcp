...
class LicenseIamPolicy < GcpResourceBase
  name 'google_compute_license_iam_policy'
  desc 'License Iam Policy'
  ...
  def resource_base_url
    '/projects/{{project}}/global/licenses/{{name}}/getIamPolicy'
  end
end
