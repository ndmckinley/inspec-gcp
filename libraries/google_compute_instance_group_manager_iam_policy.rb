...
class InstanceGroupManagerIamPolicy < GcpResourceBase
  name 'google_compute_instance_group_manager_iam_policy'
  desc 'InstanceGroupManager Iam Policy'
  ...
  def to_s
    "InstanceGroupManager IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/zones/{{zone}}/instanceGroupManagers/{{name}}/getIamPolicy'
  end
end
