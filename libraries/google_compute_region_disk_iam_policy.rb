...
class RegionDiskIamPolicy < GcpResourceBase
  name 'google_compute_region_disk_iam_policy'
  desc 'RegionDisk Iam Policy'
  ...
  def to_s
    "RegionDisk IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/disks/{{name}}/getIamPolicy'
  end
end
