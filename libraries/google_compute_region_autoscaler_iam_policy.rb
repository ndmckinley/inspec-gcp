...
class RegionAutoscalerIamPolicy < GcpResourceBase
  name 'google_compute_region_autoscaler_iam_policy'
  desc 'RegionAutoscaler Iam Policy'
  ...
  def to_s
    "RegionAutoscaler IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/autoscalers/{{name}}/getIamPolicy'
  end
end
