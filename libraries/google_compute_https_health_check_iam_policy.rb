...
class HttpsHealthCheckIamPolicy < GcpResourceBase
  name 'google_compute_https_health_check_iam_policy'
  desc 'HttpsHealthCheck Iam Policy'
  ...
  def to_s
    "HttpsHealthCheck IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/httpsHealthChecks/{{name}}/getIamPolicy'
  end
end
