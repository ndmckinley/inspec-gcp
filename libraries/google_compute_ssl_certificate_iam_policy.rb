...
class SslCertificateIamPolicy < GcpResourceBase
  name 'google_compute_ssl_certificate_iam_policy'
  desc 'SslCertificate Iam Policy'
  ...
  def to_s
    "SslCertificate IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/sslCertificates/{{name}}/getIamPolicy'
  end
end
