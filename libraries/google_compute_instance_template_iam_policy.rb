...
class InstanceTemplateIamPolicy < GcpResourceBase
  name 'google_compute_instance_template_iam_policy'
  desc 'InstanceTemplate Iam Policy'
  ...
  def to_s
    "InstanceTemplate IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/instanceTemplates/{{name}}/getIamPolicy'
  end
end
