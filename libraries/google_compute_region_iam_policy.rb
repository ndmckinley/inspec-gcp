...
class RegionIamPolicy < GcpResourceBase
  name 'google_compute_region_iam_policy'
  desc 'Region Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{name}}/getIamPolicy'
  end
end
