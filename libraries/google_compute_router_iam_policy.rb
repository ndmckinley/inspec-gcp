...
class RouterIamPolicy < GcpResourceBase
  name 'google_compute_router_iam_policy'
  desc 'Router Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/routers/{{name}}/getIamPolicy'
  end
end
