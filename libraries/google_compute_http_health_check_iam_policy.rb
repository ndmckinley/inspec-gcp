...
class HttpHealthCheckIamPolicy < GcpResourceBase
  name 'google_compute_http_health_check_iam_policy'
  desc 'HttpHealthCheck Iam Policy'
  ...
  def to_s
    "HttpHealthCheck IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/httpHealthChecks/{{name}}/getIamPolicy'
  end
end
