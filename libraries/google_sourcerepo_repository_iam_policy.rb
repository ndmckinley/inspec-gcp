...
# A provider to manage Cloud Source Repositories IAM Policy resources.
class RepositoryIamPolicy < GcpResourceBase
  name 'google_sourcerepo_repository_iam_policy'
  desc 'Repository Iam Policy'
  ...
  def to_s
    "Repository IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/repos/{{name}}/getIamPolicy'
  end
end
