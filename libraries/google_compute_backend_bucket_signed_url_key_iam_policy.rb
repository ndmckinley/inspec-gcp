...
class BackendBucketSignedUrlKeyIamPolicy < GcpResourceBase
  name 'google_compute_backend_bucket_signed_url_key_iam_policy'
  desc 'BackendBucketSignedUrlKey Iam Policy'
  ...
  def to_s
    "BackendBucketSignedUrlKey IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/backendBuckets/{{backend_bucket}}/getIamPolicy'
  end
end
