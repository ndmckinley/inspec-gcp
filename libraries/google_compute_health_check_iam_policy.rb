...
class HealthCheckIamPolicy < GcpResourceBase
  name 'google_compute_health_check_iam_policy'
  desc 'HealthCheck Iam Policy'
  ...
  def to_s
    "HealthCheck IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/healthChecks/{{name}}/getIamPolicy'
  end
end
