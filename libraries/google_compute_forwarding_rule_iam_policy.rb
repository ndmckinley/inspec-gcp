...
class ForwardingRuleIamPolicy < GcpResourceBase
  name 'google_compute_forwarding_rule_iam_policy'
  desc 'ForwardingRule Iam Policy'
  ...
  def to_s
    "ForwardingRule IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/forwardingRules/{{name}}/getIamPolicy'
  end
end
