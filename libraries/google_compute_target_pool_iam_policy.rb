...
class TargetPoolIamPolicy < GcpResourceBase
  name 'google_compute_target_pool_iam_policy'
  desc 'TargetPool Iam Policy'
  ...
  def to_s
    "TargetPool IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/targetPools/{{name}}/getIamPolicy'
  end
end
