...
class BackendServiceSignedUrlKeyIamPolicy < GcpResourceBase
  name 'google_compute_backend_service_signed_url_key_iam_policy'
  desc 'BackendServiceSignedUrlKey Iam Policy'
  ...
  def to_s
    "BackendServiceSignedUrlKey IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/backendServices/{{backend_service}}/getIamPolicy'
  end
end
