...
class InterconnectAttachmentIamPolicy < GcpResourceBase
  name 'google_compute_interconnect_attachment_iam_policy'
  desc 'InterconnectAttachment Iam Policy'
  ...
  def to_s
    "InterconnectAttachment IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/regions/{{region}}/interconnectAttachments/{{name}}/getIamPolicy'
  end
end
