...
class GlobalAddressIamPolicy < GcpResourceBase
  name 'google_compute_global_address_iam_policy'
  desc 'GlobalAddress Iam Policy'
  ...
  def to_s
    "GlobalAddress IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/addresses/{{name}}/getIamPolicy'
  end
end
