...
class KubeConfigIamPolicy < GcpResourceBase
  name 'google_container_kube_config_iam_policy'
  desc 'KubeConfig Iam Policy'
  ...
  def to_s
    "KubeConfig IamPolicy #{@params[:name]}"
  end
