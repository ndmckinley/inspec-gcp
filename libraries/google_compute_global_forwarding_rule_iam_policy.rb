...
class GlobalForwardingRuleIamPolicy < GcpResourceBase
  name 'google_compute_global_forwarding_rule_iam_policy'
  desc 'GlobalForwardingRule Iam Policy'
  ...
  def to_s
    "GlobalForwardingRule IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/forwardingRules/{{name}}/getIamPolicy'
  end
end
