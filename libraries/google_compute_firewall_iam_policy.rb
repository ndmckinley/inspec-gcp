...
class FirewallIamPolicy < GcpResourceBase
  name 'google_compute_firewall_iam_policy'
  desc 'Firewall Iam Policy'
  ...
  def to_s
    "Firewall IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/firewalls/{{name}}/getIamPolicy'
  end
end
