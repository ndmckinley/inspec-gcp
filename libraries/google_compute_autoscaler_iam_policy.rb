...
class AutoscalerIamPolicy < GcpResourceBase
  name 'google_compute_autoscaler_iam_policy'
  desc 'Autoscaler Iam Policy'
  ...
  def to_s
    "Autoscaler IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/zones/{{zone}}/autoscalers/{{name}}/getIamPolicy'
  end
end
