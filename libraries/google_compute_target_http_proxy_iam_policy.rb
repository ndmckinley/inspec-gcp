...
class TargetHttpProxyIamPolicy < GcpResourceBase
  name 'google_compute_target_http_proxy_iam_policy'
  desc 'TargetHttpProxy Iam Policy'
  ...
  def to_s
    "TargetHttpProxy IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/targetHttpProxies/{{name}}/getIamPolicy'
  end
end
