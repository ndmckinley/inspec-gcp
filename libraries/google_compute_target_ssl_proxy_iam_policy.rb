...
class TargetSslProxyIamPolicy < GcpResourceBase
  name 'google_compute_target_ssl_proxy_iam_policy'
  desc 'TargetSslProxy Iam Policy'
  ...
  def to_s
    "TargetSslProxy IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/targetSslProxies/{{name}}/getIamPolicy'
  end
end
