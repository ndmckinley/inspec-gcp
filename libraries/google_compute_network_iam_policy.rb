...
class NetworkIamPolicy < GcpResourceBase
  name 'google_compute_network_iam_policy'
  desc 'Network Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/global/networks/{{name}}/getIamPolicy'
  end
end
