...
class SslPolicyIamPolicy < GcpResourceBase
  name 'google_compute_ssl_policy_iam_policy'
  desc 'SslPolicy Iam Policy'
  ...
  def to_s
    "SslPolicy IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/global/sslPolicies/{{name}}/getIamPolicy'
  end
end
