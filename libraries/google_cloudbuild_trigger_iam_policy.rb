...
# A provider to manage Cloud Build IAM Policy resources.
class TriggerIamPolicy < GcpResourceBase
  name 'google_cloudbuild_trigger_iam_policy'
  desc 'Trigger Iam Policy'
  ...
  def resource_base_url
    'projects/{{project}}/triggers/{{id}}/getIamPolicy'
  end
end
