...
class LienIamPolicy < GcpResourceBase
  name 'google_resourcemanager_lien_iam_policy'
  desc 'Lien Iam Policy'
  ...
  def resource_base_url
    'liens?parent={{parent}}/getIamPolicy'
  end
end
