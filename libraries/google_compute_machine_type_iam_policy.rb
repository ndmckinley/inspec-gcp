...
class MachineTypeIamPolicy < GcpResourceBase
  name 'google_compute_machine_type_iam_policy'
  desc 'MachineType Iam Policy'
  ...
  def to_s
    "MachineType IamPolicy #{@params[:name]}"
  end
  ...
  def resource_base_url
    'projects/{{project}}/zones/{{zone}}/machineTypes/{{name}}/getIamPolicy'
  end
end
