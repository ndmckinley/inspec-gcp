...
filestore_instance = attribute('filestore_instance', default: {"name"=>"inspec_gcp", "zone"=>"us-central1-b", "tier"=>"PREMIUM", "fileshare_capacity_gb"=>2660, "fileshare_name"=>"inspec_gcp", "network_name"=>"default", "network_mode"=>"MODE_IPV4"})
