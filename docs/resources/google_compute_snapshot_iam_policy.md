...
## Examples
```
describe google_compute_snapshot_iam_policy(project: "project", name: "name") do
  it { should exist }
end

describe google_compute_snapshot_iam_policy(project: "project", name: "name").bindings do |binding|
